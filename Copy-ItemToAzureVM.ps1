...
workflow Copy-ItemToAzureVM {
 ...
 Copy-ItemToAzureVM -AzureSubscriptionName "SOA-INFRA-NoProd-01-17-2018" -ServiceName "VAMOS" -VMName "AMOS" -VMCredentialName "" -LocalPath "C:\Users\Krishna.Raparla\Desktop\Useful_Scripts\Automation\myFile.txt" -RemotePath "/home/amos/ssrana/automation/myFileCopy.txt" -AzureOrgIdCredential $cred
